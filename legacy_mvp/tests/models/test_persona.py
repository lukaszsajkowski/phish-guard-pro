...
Test Categories:
- PersonaType enum values and properties
- PersonaProfile valid construction
- PersonaProfile field validation
- PersonaProfile properties (summary)
- PersonaProfile immutability
