...
class IOCType(str, Enum):
    ...
    @property
    def icon(self) -> str:
        """Get icon for the IOC type."""
        icons = {
            IOCType.BTC_WALLET: "\U000020bf",  # Bitcoin symbol
            IOCType.IBAN: "\U0001f3e6",  # Bank
            IOCType.PHONE: "\U0001f4de",  # Telephone
            IOCType.URL: "\U0001f517",  # Link
        }
        return icons.get(self, "\U0001f50d")  # Magnifying glass default
