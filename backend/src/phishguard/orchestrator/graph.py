...
def should_continue_after_classification(
    ...
    logger.info("Routing: Email is phishing, continuing to persona selection")
...
def create_phishguard_graph() -> StateGraph:
    ...
    3. select_persona: Select appropriate victim persona
    4. generate_response: Generate response in persona style
    5. validate_safety: Check response safety
    6. (conditional) If unsafe -> regenerate
    7. add_bot_response: Add response to conversation history
    8. END (wait for scammer message)
